"""Shared RC2 vocabulary. States are ordinal only for deterministic transitions."""
CAPABILITY_STATES = ('UNKNOWN','EXPOSED','GUIDED','PARTIALLY_INDEPENDENT','INDEPENDENT',
                     'TRANSFERRED','RETAINED','RESEARCH_USABLE')
