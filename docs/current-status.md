...
The first four sequential v1.2 stages, a versioned bidirectional
...
Obsidian projection into the existing four subject roots.
It targets four GPT tutor conversations as the complete learner-facing surface,
backed by one Gallop Journal/application. Bounded context packets,
fresh-chat restoration,
